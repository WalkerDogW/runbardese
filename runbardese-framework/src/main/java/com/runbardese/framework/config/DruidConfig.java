...
import com.runbardese.framework.config.properties.DruidProperties;
...
import com.runbardese.framework.datasource.DynamicDataSource;
...
public class DruidConfig
{
    ...
    public DataSource slave6DataSource(DruidProperties druidProperties)
    {
        this.druidProperties = druidProperties;
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    ...
    public DataSource slave7DataSource(DruidProperties druidProperties)
    {
        this.druidProperties = druidProperties;
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.slave8")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.slave8", name = "enabled", havingValue = "true")
    public DataSource slave8DataSource(DruidProperties druidProperties)
    {
        this.druidProperties = druidProperties;
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource)
    {
        ...
        setDataSource(targetDataSources, DataSourceType.SLAVE6.name(), "slave6DataSource");
        setDataSource(targetDataSources, DataSourceType.SLAVE7.name(), "slave7DataSource");
        setDataSource(targetDataSources, DataSourceType.SLAVE8.name(), "slave8DataSource");
